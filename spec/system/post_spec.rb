...
RSpec.describe 'Post', type: :system do
    before (:example) do
        @tom =  User.create(name: 'Tom', photo: 'https://static.wikia.nocookie.net/tomandjerry/images/1/14/Tom_Cat_2.png/revision/latest?cb=20200412163656', bio: 'I am a cat')
        @jerry = User.create(name: 'Jerry', photo: 'https://static.wikia.nocookie.net/tomandjerry/images/1/14/Jerry_Mouse_2.png/revision/latest?cb=20200412163656', bio: 'I am a mouse')
